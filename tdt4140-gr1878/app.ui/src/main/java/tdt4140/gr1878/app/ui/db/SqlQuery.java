...
public class SqlQuery {
	...
	private SqlQuery() {} // Do not instantiate this
	...
	private static StringBuilder fetchSql(String path) throws IOException {
		...
		InputStream is = SqlQuery.class.getResourceAsStream(path);
	 ...
	 * <blockquote>
	 * <code>
	 * String myQuery = {@link SqlQuery}.parseSqlFile("/myquery.sql");
	 * </code>
	 * </blockquote>
	 * 
	 ...
	 * <blockquote>
	 * <code>
	 * String myQuery = {@link SqlQuery}.parseSqlFileWithParameters("/myquery.sql", 5, "Petter Hanssen");
	 * </code>
	 * </blockquote>
	 * 
	 * @param path the path to the sql resource
