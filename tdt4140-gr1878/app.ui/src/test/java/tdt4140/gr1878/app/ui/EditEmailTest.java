...
public class EditEmailTest {
	...
	public void createTestUser() {
		db.query_update(
				"INSERT INTO users (users_username, users_password, users_email, users_birthday, users_weight, users_height, users_name, privacy ) VALUES ('Marius','Pass', +"
				+ "'lol@gmail.com', + '32', + '32', '32','mac',0  );");
	}
}
