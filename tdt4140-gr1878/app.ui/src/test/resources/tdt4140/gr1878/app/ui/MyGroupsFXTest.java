...
import tdt4140.gr1878.app.ui.MyGroupsController;
...
public class MyGroupsFXTest extends ApplicationTest {


	private MyGroupsController controller;

	@Override
	public void start(Stage stage) throws Exception {
		stage = new Stage();

		FXMLLoader loader = new FXMLLoader(getClass().getResource("/tdt4140/gr1878/app/ui/MyGroups.fxml"));
