...
import tdt4140.gr1878.app.ui.MyProfileEditController;
...
public class MyProfileEditFXTest extends ApplicationTest {


	private MyProfileEditController controller;

	@Override
	public void start(Stage stage) throws Exception {
		stage = new Stage();

		FXMLLoader loader = new FXMLLoader(getClass().getResource("/tdt4140/gr1878/app/ui/MyProfileEdit.fxml"));
