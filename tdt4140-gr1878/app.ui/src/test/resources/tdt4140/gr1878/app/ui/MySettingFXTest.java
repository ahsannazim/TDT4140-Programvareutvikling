...
import tdt4140.gr1878.app.ui.MySettingsController;
...
public class MySettingFXTest extends ApplicationTest {


	private MySettingsController controller;

	@Override
	public void start(Stage stage) throws Exception {
		stage = new Stage();

		FXMLLoader loader = new FXMLLoader(getClass().getResource("/tdt4140/gr1878/app/ui/MySettings.fxml"));
